    ...
    fun provideLoggingInterceptor(): HttpLoggingInterceptor {
        return HttpLoggingInterceptor().apply {
            level = if (BuildConfig.DEBUG) {
                HttpLoggingInterceptor.Level.BODY // Log request and response bodies for debug builds
            } else {
                HttpLoggingInterceptor.Level.NONE // Disable logging for production builds
            }
        }
    }
